...
(function() {
  ...
  grammar = {
    ...
    Case: [
      o('CASE CaseWhen END', function() {
        return new Case($2);
      }), o('CASE CaseWhen CaseElse END', function() {
        return new Case($2, $3);
      })
    ],
    CaseWhen: [
    ...
    CaseWhens: [
      o('CaseWhen', function() {
        return [$1];
      }, o('CaseWhens SEPARATOR CaseWhen', function() {
        return $1.concat($3);
      }))
    ],
    CaseElse: [
    ...
    Function: [
      ...
      }), o("FUNCTION LEFT_PAREN Case RIGHT_PAREN", function() {
        return new FunctionValue($1, $3);
      })
    ],
    UserFunction: [
